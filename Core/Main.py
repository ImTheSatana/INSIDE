...
def main(page: Page):
    ...
    def color_change(e):
        ...
        global color
        color = choice(_color)
        banner.controls = [Text(spans=[TextSpan('TIGLACK', TextStyle(size=45, foreground=Paint(color=color, stroke_width=9, stroke_join='round', style='stroke')))], font_family='Consolas'), Text(spans=[TextSpan('TIGLACK', TextStyle(size=45, color=color))], font_family='Consolas')]
    ...
    # Баннер
    banner = Stack([Text(spans=[TextSpan('TIGLACK', TextStyle(size=45, foreground=Paint(color=color, stroke_width=9, stroke_join='round', style='stroke')))], font_family='Consolas'), Text(spans=[TextSpan('TIGLACK', TextStyle(size=45, color=color))], font_family='Consolas')])
    ...
    def ADD():
        ...
        page.add(
                ...
                attack_button,
                Text('\n', size=12),
                Row([IconButton(icon='telegram', icon_size=48, tooltip='Канал', url='https://t.me/tiglack_arxiv', icon_color=color),
                    IconButton(icon='telegram', icon_size=48, tooltip='Владелец', url='https://t.me/tiglack_blvck', icon_color=color),
                    IconButton(icon='attach_money', icon_size=48, tooltip='Донат', url='https://t.me/tiglack_blvck', icon_color=color),
